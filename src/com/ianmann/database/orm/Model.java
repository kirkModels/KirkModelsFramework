...
import com.ianmann.database.orm.scema.fields.DecimalField;
...
import com.ianmann.database.orm.schema.queries.AddColumn;
import com.ianmann.database.orm.schema.queries.AddForeignKey;
import com.ianmann.database.orm.schema.queries.ColumnDefinitionChange;
import com.ianmann.database.orm.schema.queries.ColumnOperation;
import com.ianmann.database.orm.schema.queries.DropConstraint;
import com.ianmann.database.orm.schema.queries.DropField;
import com.ianmann.database.orm.schema.queries.Operation;
import com.ianmann.database.orm.schema.queries.RenameField;
...
public abstract class Model {
	 ...
	 * does not exist in this class (com.ianmann.database.orm.orm.Model). It is meant to b added to the 
	...
	/**
	 * <p>Returns the operations as {@code com.ianmann.database.orm.schema.queries.ColumnOperation} objects 
	 ...
	 * {@code com.ianmann.database.orm.schema.MigrationGenerator}.</p>
	 * 
	 * @param _newField
	 * @param _column
	 * @return
	...
	public ArrayList<ColumnOperation> getOperationsForField(SavableField<?> _newField, MetaTableColumn _column) {
		...
		for (String operationDesc : diffs.keySet()) {
			if (operationDesc.equals("type")) {
				...
				// If the null constraint has changed, add that change as a com.ianmann.database.orm.schema.queries.ColumnDefinitionChange to operations
				if (_newField.isNull) {
				...
				// If the default value has changed, add that change as a com.ianmann.database.orm.schema.queries.ColumnDefinitionChange to operations
				...
				// If the size of the field has changed, add that change as a com.ianmann.database.orm.schema.queries.ColumnDefinitionChange to operations
